  ...
  return (
    <div className="app-container">
      <header>
        ...
        <p>This example demonstrates using the WaitlistForm component with all features enabled.</p>
      </header>
          ...
          <WaitlistForm 
            ...
            onSuccess={async (data) => {
              ...
              try {
                ...
                // Log expected Resend CORS error
                logApiCall('RESEND_AUDIENCE', { 
                  note: 'This call will fail due to CORS restrictions in browser',
      ...
      <div className="cors-warning-banner">
        <h3>⚠️ Important: Known limitations in this example</h3>
        <p>
          <strong>reCAPTCHA Verification:</strong> This example uses direct verification with the reCAPTCHA secret key, 
          which will fail with CORS errors in the browser. This is expected and by design, as Google's reCAPTCHA API 
          doesn't support direct client-side verification.
        </p>
        <p>
          <strong>Resend Integration:</strong> Similarly, direct Resend API calls will fail with CORS errors in the browser.
          Use a server-side proxy for production implementations.
        </p>
        <p>
          <strong>For production use:</strong> Use the "Client-Side with Proxy" approach instead, which routes verification 
          through your server to avoid CORS issues. See the complete example at:
        </p>
        <p className="example-link">
          <a href="https://github.com/pmatheusvinhas/react-waitlist-example-client-proxy" target="_blank" rel="noopener noreferrer">
            https://github.com/pmatheusvinhas/react-waitlist-example-client-proxy
          </a>
        </p>
      </div>

      <footer>
        <p>This is an example of using React Waitlist with all features enabled.</p>
        <p>
